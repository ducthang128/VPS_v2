...
class Authentication
{
	...
	/**
	 * Class replace mail() function
	 */
    public function send_email($to_custommer_email='',$custommer_name='',$subject,$content,$attachfilepath='',$debug=0){
        include APPPATH . 'third_party/sendmail/PHPMailerAutoload.php';
        ...
        $mail->Username = "hcmbes2015@gmail.com";

        //Password to use for SMTP authentication
        $mail->Password = "ducthang@123";

        //Set who the message is to be sent from
        $mail->setFrom('hcmbes2015@gmail.com', 'BES 2015');

        //Set an alternative reply-to address

        $mail->addReplyTo('hcmbes2015@gmail.com', 'BES 2015');

        //Set who the message is to be sent to
        if ($to_custommer_email == ''){
            $to_custommer_email = 'ducthang128@gmail.com';
        }
        if ($custommer_name == ''){
            $custommer_name = 'Web master';
        }
        $mail->addAddress($to_custommer_email, $custommer_name);
